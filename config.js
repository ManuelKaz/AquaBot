...
module.exports = {
    VERSION: 'MAN 1.0 beta',
    CHANNEL: 'https://t.me/',
    SESSION: process.env.AQUA_SESSION === undefined ? '' : process.env.AQUA_SESSION,
    FOOTER: process.env.FOOTER === undefined ? '𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 KAZEMBE' : process.env.FOOTER,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 MANUEL' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 MANUEL' : process.env.CAPTION,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'MAN USER' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Manuel bot' : process.env.BOT_NAME,
    WELCOME_GIF: process.env.WELCOME_GIF === undefined ? 'https://c.tenor.com/qV9QZcasa-QAAAAd/welcome.gif' : process.env.WELCOME_GIF,
    LOGO_WELCOME: process.env.LOGO_WELCOME === undefined ? 'https://cdn.vectorstock.com/i/1000x1000/46/90/welcome-concept-word-art-vector-21504690.webp' : process.env.LOGO_WELCOME,
    ...
    BYE_GIF: process.env.BYE_GIF === undefined ? 'https://gifdb.com/images/high/woody-goodbye-so-long-partner-68nvlmrhevh5pvmz.webp' : process.env.BYE_GIF,
    ...
    SONG_DOWN: process.env.SONG_DOWN === undefined ? '*♦️ Your song is being downloaded...*' : process.env.SONG_DOWN,
    SONG_UP: process.env.SONG_UP === undefined ? '*♦️ Your song is being uploaded...*' : process.env.SONG_UP,
    VIDEO_DOWN: process.env.VIDEO_DOWN === undefined ? '*♦️ Your video is downloading...*' : process.env.VIDEO_DOWN,
    VIDEO_UP: process.env.VIDEO_UP === undefined ? '*♦️ Your video is uploading...*' : process.env.VIDEO_UP,
    CAPTION_MSG: process.env.CAPTION_MSG === undefined ? 'copyright (c) 2022 manuelbot' : process.env.CAPTION_MSG,
